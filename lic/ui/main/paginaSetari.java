...
public class paginaSetari extends Fragment implements TabLayout.OnTabSelectedListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_pagina_setari, container, false);
        sharedPreferences = new SharedPrefs(getContext());
        tabLayout  = getActivity().findViewById(R.id.tabsH); // Obține obiectul TabLayout
        tabLayout.addOnTabSelectedListener(this);

        termeni = inflate.findViewById(R.id.textViewTermeniSiConditii);
        ajutor = inflate.findViewById(R.id.textViewAjutor);

        switchNightMode = inflate.findViewById(R.id.switchNightMode);
        //switchNightMode.setChecked(sharedPreferences.getDarkTheme() == true);

        switchNotificari = inflate.findViewById(R.id.switchNotificari);
        //switchNotificari.setChecked(sharedPreferences.getNotifications()==true);
        adaugaCard = inflate.findViewById(R.id.buttonAdaugaCard);

        fragmentCard = inflate.findViewById(R.id.fragmentCard);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adaugaCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.add(R.id.fragmentCard, pCard);
