...
public class OnboardingCourierActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onboarding_courier);
        imgBtnProfil= findViewById(R.id.imageButtonCurier);
        imgVHand=findViewById(R.id.hand_image_view_courier);
        btnConfirma= findViewById(R.id.buttonConfirmaCurier);
        roteste = findViewById(R.id.imageButtonRoteste);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        imag = dataSnapshot.getValue(String.class);
                        if(!imag.equals("nespecificat"))
                        {

                            Intent i = new Intent(OnboardingCourierActivity.this, CourierHomeActivity.class);
                            startActivity(i);
                            finish();
                        }
                        else
                        {    String positiveButtonText = "OK";
                            ...
                            alert = new AlertDialog.Builder(OnboardingCourierActivity.this).create();
                            alert.setTitle("AVERTIZARE");

                            alert.setMessage("Nu ati adaugat o imagine de profil");
            ...
            storageReference2nd.putFile(image_uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (uriTask.isSuccessful()) {
                        ...
                        Toast.makeText(OnboardingCourierActivity.this, "A aparut o eroare", Toast.LENGTH_SHORT).show();
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(OnboardingCourierActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void loadButton()
    {
        databaseReference.addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    {
                        Toast
                                .makeText(OnboardingCourierActivity.this,
                                        "Error Loading Image",
                                        Toast.LENGTH_SHORT)
                                .show();
                    }
